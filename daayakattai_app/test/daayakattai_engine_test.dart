...
void main() {
  group('DaayakattaiGame Rules Tests', () {
    ...
    test('Pairs (Jodu) Blocking - Single piece cannot land on safe cell double occupied', () {
      ...
      // Player 0 starts at index 13. To place pieces at absolute index 15 (safe cell),
      // we need outerSteps = (15 - 13 + 56) % 56 = 2
      game.debugSetupPiece(0, 0, PieceState.outer, outerSteps: 2);
      game.debugSetupPiece(0, 1, PieceState.outer, outerSteps: 2);

      // Verify they form a pair on outer cell 15
      expect(p0.pieces[0].outerIndex, equals(15));
      expect(p0.pieces[1].outerIndex, equals(15));

      // Player 1 starts at index 27. To place a piece at absolute index 15,
      // we need outerSteps = (15 - 27 + 56) % 56 = 44
      game.debugSetupPiece(1, 0, PieceState.outer, outerSteps: 44);
      
      // Verify Player 1's piece is at index 15
      expect(p1.pieces[0].outerIndex, equals(15));

      // Since cell 15 is safe and occupied by Player 0's pair, it should block Player 1.
      final targetCoord = Board.outerTrack[15];
