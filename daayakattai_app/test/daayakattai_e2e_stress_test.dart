...
void main() {
  group('Daayakattai E2E Rules Edge Cases & Stress Tests', () {
    ...
    test('Vettu Lock - Branching to inner path requires at least one cut (Vettu)', () {
      ...
      // Put a piece at absolute outer index 13 (Player 0 startOuterIndex is 13)
      game.debugSetupPiece(0, 0, PieceState.outer, outerSteps: 0);

      // Verify Player 0 has no Vettu yet
      expect(p0.hasVettu, isFalse);

      // Loop piece to gate (outerSteps = 56)
      game.debugSetupPiece(0, 0, PieceState.outer, outerSteps: 56);
    ...
    test('Jodu Blocking - Safe double-occupied cells block opponent landings', () {
      ...
      // Form a Jodu pair on outer index 15 (Player 0 starts at index 13 -> outerSteps: 2)
      ...
      // Player 1 starts at index 27. Place opponent right at index 15 (outerSteps: 44)
